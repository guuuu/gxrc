import { Route, HashRouter as Router, Routes as Switch, Navigate, } from "react-router-dom";
...
const Routes = () => {
	return (
		<>
			<Router>
				<Switch>
					<Route caseSensitive path="/" element={<Navigate replace to={RouterPaths.HOME} />} />
